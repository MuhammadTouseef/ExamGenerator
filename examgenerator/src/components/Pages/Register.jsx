...
export const Register = () => {
 ...
 try{
  ...
  return (
    <div className="loginpage f-center">
      <div className="loginform">
        <h1>Register</h1>
        <input type="text" placeholder="Name" className="fofe" onChange={e => setname(e.target.value)} />
        ...
        <input type="password" placeholder="Re type Password" className="fofe" />
        <select name="role" className="fofe" onChange={e => setrole(e.target.value)}>
  ...
  <option value="Teacher">Teacher</option>
        ...
        <button className="logbtn" onClick={regis}>Register</button>
